...
class BacktestEngine:
  ...
  def run(
    ...
    if warmup_bars < 0 or warmup_bars >= len(candles):
      raise ValueError(
        "warmup_bars must be between 0 and the number of candles minus 1"
      )
    ...
    for index, candle in enumerate(candles):
      ...
      # Warm-up candles build indicator history but do not execute trades
      # or contribute to backtest equity.
